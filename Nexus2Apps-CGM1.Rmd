...
## Basic Conventional Gait Model

The **basic** variant of the CGM1 calibrates Knee and Ankle joint centres from wands and lateral markers  

### Flowchart 
 
The **Reconstruct** operation can be run either on static acquisition or gait trials. The primary goal of **Reconstruct** is to generate a **New c3d Acquisition** with kinematics and kinetics. Optionnaly, you can enable gait trace or static angle profile plotting. 
 ...
 * Select script file `Apps/CGM1-pyCGM2/nexusOperation-pyCGM2-CGM1-Reconstruction.py`.
